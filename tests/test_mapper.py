...
def test_enter_maps_to_partner_out_using_local_entry_channel() -> None:
    ...
    payload = map_to_partner_payload(
        sample_event("20260412_063354_226439_body.bin"),
...
def test_exit_maps_to_partner_in_using_local_exit_channel() -> None:
    ...
    payload = map_to_partner_payload(
        sample_event("20260412_092815_853600_body.bin"),
...
def test_mapping_uses_configured_hobby_values() -> None:
    ...
    enter_payload = map_to_partner_payload(sample_event("20260412_063354_226439_body.bin"), config)
    exit_payload = map_to_partner_payload(sample_event("20260412_092815_853600_body.bin"), config)
...
def test_filter_accepts_stop_but_rejects_no_plate() -> None:
    ...
    stop_event = sample_event("20260412_071503_319787_body.bin")
    assert should_forward(stop_event) == (True, "")

    no_plate_event = replace(sample_event("20260412_113252_857892_body.bin"), passing_type="plateRecognition")
...
def test_filter_accepts_manual_passing_type() -> None:
    ...
    manual_event = replace(sample_event("20260412_063354_226439_body.bin"), passing_type="manual")
